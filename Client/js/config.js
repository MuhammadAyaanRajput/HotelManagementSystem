...
const MODULES = {
  ...
  rooms: {
    ...
    fields: [
      ...
      { name: 'floor_no', label: 'Floor No', type: 'number', required: true },
      {
        ...
        label: 'Status',
        type: 'select',
        options: ['Available', 'Occupied', 'Maintenance', 'Cleaning'],
        required: true,
      },
    ],
    columns: [
    ...
    fields: [
      {
        ...
        type: 'select',
        ref: 'guests',
        refLabel: (r) => `${r.first_name} ${r.last_name}`,
        required: true,
      },
      {
        name: 'room_id',
        ...
        type: 'select',
        ref: 'rooms',
        refLabel: (r) => `Room ${r.room_number} · ${r.type_name}`,
        required: true,
      },
      {
        name: 'booking_date',
    ...
    fields: [
      {
        ...
        ref: 'reservation',
        refLabel: (r) =>
          `#${r.reservation_id} · ${r.first_name} ${r.last_name} · Room ${r.room_number}`,
        required: true,
      },
      {
        name: 'checkin_time',
    ...
    fields: [
      {
        ...
        ref: 'checkins',
        refLabel: (r) =>
          `#${r.checkin_id} · ${r.first_name} ${r.last_name} · Room ${r.room_number}`,
        required: true,
      },
      {
        name: 'checkout_time',
  ...
  guestservices: {
    endpoint: 'guestservices',
    idKey: 'guest_service_id',
    ...
    fields: [
      {
        ...
        ref: 'reservation',
        refLabel: (r) =>
          `#${r.reservation_id} · ${r.first_name} ${r.last_name}`,
        required: true,
      },
      {
        name: 'service_id',
        ...
        type: 'select',
        ref: 'services',
        refLabel: (r) => `${r.service_name} ($${r.price})`,
        required: true,
      },
    ...
    fields: [
      {
        ...
        ref: 'bills',
        refLabel: (r) =>
          `#${r.bill_id} · ${r.first_name} ${r.last_name} · $${r.total_amount}`,
        required: true,
      },
      {
        name: 'amount_paid',
      ...
      },
      {
        ...
        type: 'select',
        options: ['Cash', 'Card', 'Online', 'UPI', 'Bank Transfer'],
        required: true,
      },
      {
        name: 'payment_status',
  ...
  housekeeping: {
    ...
    columns: [
      { key: 'room_number', label: 'Room', mono: true },
      {
        ...
        label: 'Staff',
        combineWith: 'employee_last_name',
      },
